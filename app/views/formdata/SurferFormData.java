...
public class SurferFormData {
  ...
  /**
   * Constructs a SurferFormData object manually.
   * Currently only used by Global.java to create initial Surfers on application startup.
   * NOTE: This doesn't currently check if slug already exists. Use with care.
   * 
   ...
   * The following fields must be non-empty: Name, Home, Carousel URL, Bio URL, Biography.
